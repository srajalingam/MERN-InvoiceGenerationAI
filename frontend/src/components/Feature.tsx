      ...
      <div className={featuresStyles.container}>
        <div className={featuresStyles.headerContainer}>
          <div className={featuresStyles.badge}>
            ...
            <span className={featuresStyles.badgeText}>Powerul Features</span>
          </div>
          ...
          <p className={featuresStyles.subtitle}>
            Experience the future of invoicing with our AI-powered features
            designed to save you time and get you paid faster.
          </p>
        </div>
        <div className={featuresStyles.featuresGrid}>
          {features.map((feature, index) => (
            <FeatureCard
              ...
              desc={feature.desc}
              icon={feature.icon}
              delay={index * 100} // Stagger animation by 200ms
            />
          ))}
        </div>
