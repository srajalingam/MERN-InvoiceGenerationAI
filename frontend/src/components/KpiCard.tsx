...
interface KpiCardProps {
  ...
  value: string | number;
  hint?: string;
  iconType?: "default" | "revenue" | "growth" | "document" | "clock";
  trend?: number;
  className?: string;
}
...
function KpiCard({
  ...
  const Icon =
    MetricIcons[iconType as keyof typeof MetricIcons] || MetricIcons.default;
  ...
  const getIconColor = (iconType: string) => {
    return (
      kpiCardStyles.iconColors[
        iconType as keyof typeof kpiCardStyles.iconColors
