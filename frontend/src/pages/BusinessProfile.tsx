...
import { businessProfileStyles, customStyles, iconColors } from "../assets/dummyStyles";
  ...
  return (
    <div className={businessProfileStyles.pageContainer}>
      <div className={businessProfileStyles.headerContainer}>
        ...
        {!isSignedIn && <div>You are nit signed</div>}
      </div>
      <form
        onSubmit={handleSave}
      ...
      >
        ...
        <div>
            <button type="submit" onClick={handleSave} className={businessProfileStyles.saveButton}>
                <SaveIcon className="w-4 h-4"></SaveIcon>{""}
